...
type ArticleItem struct {
	...
	CommentNum    int64                  `protobuf:"varint,9,opt,name=comment_num,json=commentNum,proto3" json:"comment_num,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ArticleReplyIncreaseRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ArticleId     int64                  `protobuf:"varint,1,opt,name=article_id,json=articleId,proto3" json:"article_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ArticleReplyIncreaseRequest) Reset() {
	*x = ArticleReplyIncreaseRequest{}
	mi := &file_article_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ArticleReplyIncreaseRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ArticleReplyIncreaseRequest) ProtoMessage() {}

func (x *ArticleReplyIncreaseRequest) ProtoReflect() protoreflect.Message {
	mi := &file_article_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ArticleReplyIncreaseRequest.ProtoReflect.Descriptor instead.
func (*ArticleReplyIncreaseRequest) Descriptor() ([]byte, []int) {
	return file_article_proto_rawDescGZIP(), []int{16}
}

func (x *ArticleReplyIncreaseRequest) GetArticleId() int64 {
	if x != nil {
		return x.ArticleId
	}
	return 0
...
type ArticleReplyIncreaseResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ArticleReplyIncreaseResponse) Reset() {
	*x = ArticleReplyIncreaseResponse{}
	mi := &file_article_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ArticleReplyIncreaseResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ArticleReplyIncreaseResponse) ProtoMessage() {}

func (x *ArticleReplyIncreaseResponse) ProtoReflect() protoreflect.Message {
	mi := &file_article_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ArticleReplyIncreaseResponse.ProtoReflect.Descriptor instead.
func (*ArticleReplyIncreaseResponse) Descriptor() ([]byte, []int) {
...
const file_article_proto_rawDesc = "" +
	...
	"\tarticleId\x18\x05 \x01(\x03R\tarticleId\"\x87\x02\n" +
	...
	"\atag_ids\x18\b \x01(\tR\x06tagIds\x12\x1f\n" +
	...
	"\vpublishTime\x18\a \x01(\x03R\vpublishTime\"<\n" +
	"\x1bArticleReplyIncreaseRequest\x12\x1d\n" +
	"\n" +
	"article_id\x18\x01 \x01(\x03R\tarticleId\"\x1e\n" +
	"\x1cArticleReplyIncreaseResponse2\xfd\x04\n" +
	"\aArticle\x12<\n" +
	...
	"\rArticleDetail\x12\x1d.article.ArticleDetailRequest\x1a\x1e.article.ArticleDetailResponse\x12c\n" +
	"\x14ArticleReplyIncrease\x12$.article.ArticleReplyIncreaseRequest\x1a%.article.ArticleReplyIncreaseResponse\x12Q\n" +
...
var file_article_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_article_proto_goTypes = []any{
	...
	(*ArticleReplyIncreaseRequest)(nil),  // 16: article.ArticleReplyIncreaseRequest
	(*ArticleReplyIncreaseResponse)(nil), // 17: article.ArticleReplyIncreaseResponse
}
var file_article_proto_depIdxs = []int32{
	...
	16, // 7: article.Article.ArticleReplyIncrease:input_type -> article.ArticleReplyIncreaseRequest
	9,  // 8: article.Article.ApproveArticle:input_type -> article.ArticleApproveRequest
	11, // 9: article.Article.RejectArticle:input_type -> article.ArticleRejectRequest
	13, // 10: article.Article.GetPendingArticles:input_type -> article.AdminListRequest
	1,  // 11: article.Article.Publish:output_type -> article.PublishResponse
	4,  // 12: article.Article.Articles:output_type -> article.ArticlesResponse
	6,  // 13: article.Article.ArticleDelete:output_type -> article.ArticleDeleteResponse
	8,  // 14: article.Article.ArticleDetail:output_type -> article.ArticleDetailResponse
	17, // 15: article.Article.ArticleReplyIncrease:output_type -> article.ArticleReplyIncreaseResponse
	10, // 16: article.Article.ApproveArticle:output_type -> article.ArticleApproveResponse
	12, // 17: article.Article.RejectArticle:output_type -> article.ArticleRejectResponse
	14, // 18: article.Article.GetPendingArticles:output_type -> article.AdminListResponse
