...
func (x *GetQuestionsRequest) GetCursor() int64 {
	if x != nil {
		return x.Cursor
	}
	return 0
...
func (x *GetQuestionsRequest) GetQuestionId() int64 {
	if x != nil {
		return x.QuestionId
	}
	return 0
...
const file_qa_proto_rawDesc = "" +
	...
	"\x13GetQuestionsRequest\x12\x16\n" +
	...
	"\tquestions\x18\x01 \x03(\v2\f.qa.QuestionR\tquestions\x12\x19\n" +
	"\bhas_more\x18\x02 \x01(\bR\ahasMore2\xc1\x02\n" +
	"\tQaService\x12D\n" +
	...
	"\n" +
	"GetAnswers\x12\x15.qa.GetAnswersRequest\x1a\x13.qa.GetAnswersReply\x12A\n" +
	"\fGetQuestions\x12\x17.qa.GetQuestionsRequest\x1a\x18.qa.GetQuestionsResponseB\x06Z\x04./qab\x06proto3"
...
var file_qa_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_qa_proto_goTypes = []any{
	...
	(*GetQuestionsRequest)(nil),   // 10: qa.GetQuestionsRequest
	(*GetQuestionsResponse)(nil),  // 11: qa.GetQuestionsResponse
}
var file_qa_proto_depIdxs = []int32{
	...
	3,  // 2: qa.GetQuestionsResponse.questions:type_name -> qa.Question
	0,  // 3: qa.QaService.CreateQuestion:input_type -> qa.CreateQuestionRequest
	2,  // 4: qa.QaService.GetQuestion:input_type -> qa.GetQuestionRequest
	5,  // 5: qa.QaService.AnswerQuestion:input_type -> qa.AnswerRequest
	7,  // 6: qa.QaService.GetAnswers:input_type -> qa.GetAnswersRequest
	10, // 7: qa.QaService.GetQuestions:input_type -> qa.GetQuestionsRequest
	1,  // 8: qa.QaService.CreateQuestion:output_type -> qa.CreateQuestionReply
	4,  // 9: qa.QaService.GetQuestion:output_type -> qa.GetQuestionReply
	6,  // 10: qa.QaService.AnswerQuestion:output_type -> qa.AnswerReply
	9,  // 11: qa.QaService.GetAnswers:output_type -> qa.GetAnswersReply
	11, // 12: qa.QaService.GetQuestions:output_type -> qa.GetQuestionsResponse
